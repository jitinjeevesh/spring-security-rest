...
public class JWTTokenConfig {
     ...
     */
    @Value("${spring.rest.authentication.jwt.iss}")
    private String iss;
     ...
     */
    @Value("${spring.rest.authentication.jwt.exp}")
    private Integer exp;
